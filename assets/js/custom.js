...
/* Star Animation End */
                              ...
                              function openModal(mediaSrc) {
                                ...
                                if (mediaSrc.endsWith('.jpg') || mediaSrc.endsWith('.png')) {
                                    modalContent.innerHTML = `<img src="${mediaSrc}" alt="Full view">`;
                                } else if (mediaSrc.endsWith('.mp4')) {
                                    modalContent.innerHTML = `<video controls><source src="${mediaSrc}" type="video/mp4">Your browser does not support the video tag.</video>`;
                                }
